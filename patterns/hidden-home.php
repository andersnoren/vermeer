...
<p><?php echo __('I am Johannes Vermeer, born in 1853. I paint with fervent passion, crafting celebrated works despite some personal struggles. My art resonates worldwide, immortalizing my unique perspective and inspiring generations with its enduring beauty.', 'vermeer');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"metadata":{"name":"Links"},"layout":{"type":"constrained","contentSize":"395px","justifyContent":"left"}} -->
<div class="wp-block-group"><!-- wp:navigation {"overlayMenu":"never","className":"is-style-vermeer-separated-with-arrows","layout":{"type":"flex","orientation":"vertical"}} /--></div>
<!-- /wp:group -->
