...
<div class="wp-block-group"
	...
	<div class="wp-block-group">
		...
		<p class="has-text-align-center theme-author-credit has-contrast-2-color has-text-color has-link-color"><?php
			...
			$theme_author_link = '<a href="' . esc_url( __( 'https://wordpress.org', 'spielberg' ) ) . '" rel="nofollow">Anders Norén</a>';
			echo sprintf(
				/* Translators: Theme by Anders Norén */
				esc_html__( 'Theme by %1$s', 'spielberg' ),
				$theme_author_link
			);
			?></p>
		<!-- /wp:paragraph -->
