 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"16px"}}},"className":"van-gogh-is-fixed-title-header","layout":{"type":"default"}} -->
<div class="wp-block-group van-gogh-is-fixed-title-header" style="padding-top:16px"><!-- wp:heading {"level":1,"style":{"color":{"text":"#ffffff"},"elements":{"link":{"color":{"text":"#ffffff"}}}},"className":"is-style-van-gogh-marquee-left","fontSize":"huge-title"} -->
<h1 class="wp-block-heading is-style-van-gogh-marquee-left has-text-color has-link-color has-huge-title-font-size" style="color:#ffffff"><?php echo __('Error 404', 'van-gogh');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-column is-vertically-aligned-stretch"><!-- wp:cover {"overlayColor":"contrast","isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","isDark":false,"className":"is-style-van-gogh-cover-mobile-1x1","layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light is-style-van-gogh-cover-mobile-1x1" style="min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
...
<p><?php echo __('The page you’re looking for could not be found.', 'van-gogh');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"metadata":{"name":"Links"},"layout":{"type":"constrained","contentSize":"240px","justifyContent":"left"}} -->
<div class="wp-block-group"><!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"textAlign":"left","width":100,"style":{"border":{"top":{"width":"1px"},"right":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"},"left":{"width":"0px","style":"none"}},"spacing":{"padding":{"left":"0","right":"0"}}},"className":"is-style-van-gogh-icon-right-arrow"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-van-gogh-icon-right-arrow"><a class="wp-block-button__link has-text-align-left wp-element-button" style="border-top-width:1px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-style:none;border-left-width:0px;padding-right:0;padding-left:0" href="<?php echo esc_url( home_url() ); ?>"><?php echo __('Go back', 'van-gogh');?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
